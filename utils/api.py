...
class GoogleMapsApi:
    ...
    def put_new_place(place_id):
        ...
        json_for_update_new_loaction = {
            "place_id": place_id,
            "address": "23 Lenina street, RU",
            "key": "qaclick123"
        }

        result_put = HttpMethods.put(put_url, json_for_update_new_loaction)
    ...
    def delete_new_place(place_id):
        ...
        json_for_delete_new_loaction = {
            "place_id": place_id
        }

        result_delete = HttpMethods.delete(delete_url, json_for_delete_new_loaction)
